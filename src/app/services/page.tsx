    ...
    <main className="min-h-screen bg-white text-gray-900 font-['Questrial',sans-serif] pt-28 sm:pt-36">
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 pb-12 sm:pb-16 text-center sm:text-left">
        <div className="space-y-4 max-w-3xl border-b border-neutral-200/80 pb-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#d4f938]/20 border border-[#c4eb28] text-xs font-bold text-black uppercase tracking-wider">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight text-black leading-[1.08] font-['Agrandir',sans-serif]">
            ...
            <br />
            <span className="text-neutral-400">That Command Growth.</span>
          </h1>
          ...
          {[
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-xs sm:text-sm font-bold tracking-wide transition-all cursor-pointer ${
                activeTab === tab.id
                  ? "bg-black text-[#d4f938] shadow-md border border-black scale-[1.02]"
                  : "bg-neutral-100 text-neutral-600 border border-neutral-200 hover:border-neutral-400"
              }`}
            >
              {tab.label}
            </button>
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 pb-24 sm:pb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          {filteredServices.map((service) => (
            <div
              key={service.id}
              className="group rounded-[36px] bg-[#0c0d12] text-white p-8 sm:p-10 border border-neutral-800/80 shadow-2xl flex flex-col justify-between transition-all duration-500 hover:border-neutral-600 hover:shadow-[0_20px_50px_rgba(212,249,56,0.08)] relative overflow-hidden"
            >
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white group-hover:bg-[#d4f938] group-hover:text-black transition-colors">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl sm:text-3xl font-black text-white font-['Agrandir',sans-serif] tracking-tight leading-tight">
                    {service.title}
                  </h3>
                  <p className="text-sm font-semibold text-[#d4f938] font-['Questrial',sans-serif]">
                    {service.subtitle}
                  </p>
                  <p className="text-xs sm:text-sm text-neutral-400 font-['Questrial',sans-serif] leading-relaxed pt-1">
                    {service.description}
                  </p>
                </div>
              ...
              <div className="pt-6 mt-6 border-t border-neutral-800 flex flex-wrap items-center justify-between gap-4 relative z-10">
      ...
      <section className="w-full bg-[#f8f8fa] py-20 sm:py-28 border-y border-neutral-200">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 space-y-12">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-black text-black font-['Agrandir',sans-serif]">
              Engagement Models
            </h2>
            <p className="text-sm sm:text-base text-neutral-600 font-['Questrial',sans-serif]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-black text-white rounded-3xl p-8 border border-neutral-800 shadow-xl space-y-4 relative">
